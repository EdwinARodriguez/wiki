class Admin::ArticleTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_article_type.save
        format.html { redirect_to @admin_article_type, notice: 'Article type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @admin_article_type.update(admin_article_type_params)
        format.html { redirect_to @admin_article_type, notice: 'Article type was successfully updated.' }
  ...
  private
    ...
    def admin_article_type_params
      params.require(:admin_article_type).permit(:name, :description)
    end
end
